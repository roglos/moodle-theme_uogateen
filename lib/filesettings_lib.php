 ...
 * @return bool
 */
function theme_uogateen_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    static $theme;
    if (empty($theme)) {
        $theme = theme_config::load('uogateen');
    }
     ...
     */
function theme_uogateen_get_setting($setting, $format = false) {
    global $CFG;
