...
$THEME->scss = function($theme) {
    return theme_uogateen_get_main_scss_content($theme);
};
...
$THEME->csstreepostprocessor = 'theme_uogateen_css_tree_post_processor';
$THEME->prescsscallback = 'theme_uogateen_get_pre_scss';
$THEME->extrascsscallback = 'theme_uogateen_get_extra_scss';
