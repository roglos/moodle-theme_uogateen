...
$page = new admin_settingpage('theme_uogateen_presets', get_string('presets_settings', 'theme_uogateen'));

// Preset.
$name = 'theme_uogateen/preset';
$title = get_string('preset', 'theme_uogateen');
$description = get_string('preset_desc', 'theme_uogateen');
$presetchoices = '';
// Add preset files from theme preset folder.
$iterator = new DirectoryIterator($CFG->dirroot . '/theme/uogateen/scss/preset/');
...
$fs = get_file_storage();
$files = $fs->get_area_files($context->id, 'theme_uogateen', 'preset', 0, 'itemid, filepath, filename', false);
...
$name = 'theme_uogateen/presetfiles';
$title = get_string('presetfiles', 'theme_uogateen');
$description = get_string('presetfiles_desc', 'theme_uogateen');
